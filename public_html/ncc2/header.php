				...
				<ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
					<li class="nav-item col-4 col-lg-auto" id="prior">
						<a class="nav-link py-2 px-0 px-lg-2" href="index.php">
							<span class="navtitles">Languages</span>
						</a>
					</li>
					<li class="nav-item col-4 col-lg-auto">
						<a class="nav-link py-2 px-0 px-lg-2" href="https://github.com/MrIbrahem/mdwiki.toolforge.org/tree/main/public_html/ncc2" target="_blank">
